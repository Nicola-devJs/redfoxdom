...
export const AdminNavigatePanel = ({ session }: IProps) => {
  return (
    <aside className="relative min-h-full w-full max-w-[300px] flex-grow bg-dark text-white dark:bg-dark-second">
      <div className="fixed h-full max-w-[300px]">
        ...
        <div className="border-b-1 border-dark-second p-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex w-full flex-col overflow-hidden">
              <span className="text-xs font-light text-gray-second">
                Account
              </span>
