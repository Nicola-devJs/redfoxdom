...
export const HeaderMenu = () => {
  ...
  return (
    <>
      ...
      <nav
        className={cn(
          "transition max-md:pointer-events-none max-md:absolute max-md:bottom-full max-md:left-0 max-md:w-full max-md:translate-y-4 max-md:rounded-t-2xl max-md:border-y-1 max-md:border-gray max-md:bg-white max-md:p-6 max-md:opacity-0 max-md:dark:border-dark-second max-md:dark:bg-dark",
          {
